...
provisioning.yml и правим его по факту (пользователь и директория)
правим inventory - ip адрес машины из облака

нпроверяем что у нас в хостах(инвентори)
ansible all --list-hosts
пусто
указываем ему на местный inventory
...
++ результат не тот
E
[Erroryum](https://github.com/Romanru5116/devops-netology/blob/680290beef9fa002dfd56c8fc25ad4b475a53cf8/ErrorPlay.png)
++ 
